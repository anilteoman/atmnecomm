  ...
  return (
    <section className="signup-main py-10">
      <div className="signup-title py-5">
        <h2 className="text-[#252B42] text-[2.5rem] font-bold leading-[3.125rem] text-center">
          Sign Up
        </h2>
      </div>
      <div className="signup-form flex flex-col items-center">
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          <div className="form-email flex flex-col">
            <label htmlFor="email" className="text-lg leading-6">
              Email
            </label>
            <input
              {...register("email", {
          ...
          <div className="form-password flex flex-col">
            <label htmlFor="password" className="text-lg leading-6">
              Password
            </label>
            <input
              {...register("password", {
                ...
                pattern: {
                  ...
                  message:
                    "At least 8 characters including at least one upper/lower case and special characters are required.",
                },
              })}
              id="password"
              type="password"
            ...
            {errors.password && touchedFields.password && (
              <p className="w-2xs md:w-sm text-red-500 text-sm py-3">
                {errors.password.message}
              </p>
            )}
          </div>
          <div className="form-password flex flex-col">
            <label htmlFor="passValid" className="text-lg leading-6">
              Password Validation
            </label>
            <input
          ...
          <div className="form-roles flex flex-col">
            <label htmlFor="roles" className="text-lg leading-6">
              Role
            </label>
            <select
          ...
          {selectedRole == 3 && (
            <div className="form-store-info flex flex-col gap-5">
              <div className="store-name flex flex-col">
                <label htmlFor="storeName" className="text-lg leading-6">
                  Store Name
                </label>
                <input
                  {...register("store_name", {
              ...
              <div className="store-phone flex flex-col">
                <label htmlFor="storePhone" className="text-lg leading-6">
                  Store Phone
                </label>
                <input
              ...
              <div className="store-tax flex flex-col">
                <label htmlFor="storeTax" className="text-lg leading-6">
                  Store Tax ID
                </label>
                <input
              ...
              <div className="store-bank flex flex-col">
                <label htmlFor="storeBank" className="text-lg leading-6">
                  Store Bank Account
                </label>
                <input
                ...
                {errors.store_bank_account &&
                  touchedFields.store_bank_account && (
                    <p className="w-2xs text-red-500 text-sm py-3">
          ...
          <div className="form-button flex justify-center pt-2">
            <button
              ...
              type="submit"
              className="bg-[#23A6F0] disabled:bg-blue-300 disabled:hover:cursor-not-allowed text-white p-1.5 rounded w-[7rem] h-[3rem] hover:cursor-pointer flex items-center justify-center gap-2"
            >
              {isSubmitting ? (
                <FontAwesomeIcon
                  icon={faCircleNotch}
