  ...
  return (
    <section>
      <div className="filters flex flex-col md:flex-row md:justify-between py-6 md:px-[14.5rem] gap-6 items-center">
        <div className="info">
          <h6 className="text-[#737373] text-sm font-bold leading-6">
            Showing 24 results
          </h6>
        </div>
        ...
        <div className="filter-options flex gap-[0.938rem]">
          <input
            ...
            className="h-[3.125rem] w-[8.813rem] bg-[#F9F9F9] text-[#737373] text-sm leading-7 rounded-[0.313rem] border border-[#DDDDDD] pl-5"
          />
          <select
            className="h-[3.125rem] w-[8.813rem] bg-[#F9F9F9] text-[#737373] text-sm leading-7 rounded-[0.313rem] border border-[#DDDDDD] text-center"
            value={filters.sort}
          ...
          <button
            className="bg-[#23A6F0] text-white text-center py-2.5 px-5 rounded-[0.313rem] hover:cursor-pointer"
