      ...
      <div className="credit-card-form">
        ...
        >
          <div className="card-no flex flex-col">
            <label htmlFor="card_no" className="text-lg leading-6">
              Credit Card No
            </label>
            <input
              {...register("card_no", {
          ...
          <div className="card-month flex flex-col">
            <label htmlFor="expire_month" className="text-lg leading-6">
              Expire Month
            </label>
            <input
              {...register("expire_month", {
                required: "Please enter expire month",
                pattern: {
                  value: /^(0[1-9]|1[0-2])$/,
          ...
          <div className="card-year flex flex-col">
            <label htmlFor="expire_year" className="text-lg leading-6">
              Expire Year
            </label>
            <input
          ...
          <div className="card-name flex flex-col">
            <label htmlFor="name_on_card" className="text-lg leading-6">
              Name On The Card
            </label>
            <input
